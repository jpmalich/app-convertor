  ...
  return (
    <section
      className={`card mb-4 border-2 ${
        enabled ? "border-[#F97316] bg-[#FFFBEB]" : "border-[#E4E4E7] bg-white"
      }`}
        ...
        <div className="px-4 md:px-5 py-4 grid grid-cols-1 md:grid-cols-12 gap-3">
          <div className="md:col-span-3">
            ...
            <div className="flex items-center">
              <span className="px-3 h-10 inline-flex items-center bg-[#FAFAFA] border border-r-0 border-[#E4E4E7] font-mono-num text-sm text-[#52525B]">
                $
              </span>
              <input
                type="number"
          ...
          <div className="md:col-span-12 mt-1 flex items-center justify-between gap-3 px-3 py-2 bg-[#FFF7ED] border border-[#F97316]">
