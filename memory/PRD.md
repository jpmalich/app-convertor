...
- "Sync to latest supplier catalog" admin action to push price updates to opt-in companies (now more important after Iter 22 — when supplier bulk-updates prices, draft estimates should optionally refresh)
